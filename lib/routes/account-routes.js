...
router
    ...
    .post('/:id/addmember', bodyParser, (req, res, next) => {
    ...
    .post('/:id/addnewlist', bodyParser, (req, res, next) => {
        return Account.findById(req.params.id)
            .then(account => {
    ...
    .post('/:id/removemember', bodyParser, (req, res, next) => {
        return Account.findById(req.params.id)
            .then(account => {
    ...
    .post('/:id/removelist', bodyParser, (req, res, next) => {
        return Account.findById(req.params.id)
            .then(account => {
